...
# # powheg x pythia
root -l -b -q plotEff.C+\(\"mu_sta.bins\",5,1,5,1,\"${NTUPLEDIR_5}/Zmm/Data/MuStaEff/probes.root\",\"${OUTPUTDIR_5}/Zmm/Data/MuStaEff_POWxPythia${POSTFIX}/Combined\",\"png\",0,0,0,\"Muon\",\"stand-alone\",0.7,1.02,${LUMI5},\"${NTUPLEDIR_5}/Zmm/MC/MuStaEff/probes.root\"\)
# # powheg x photos
root -l -b -q plotEff.C+\(\"mu_sta.bins\",6,1,6,1,\"${NTUPLEDIR_5}/Zmm/Data/MuStaEff/probes.root\",\"${OUTPUTDIR_5}/Zmm/Data/MuStaEff_POWxPhotos${POSTFIX}/Combined\",\"png\",0,0,0,\"Muon\",\"stand-alone\",0.7,1.02,${LUMI5},\"${NTUPLEDIR_5}/Zmm/MC/MuStaEff/probes.root\"\)
# # bkg power law
...
root -l -b -q plotEff.C+\(\"mu_sta.bins\",2,1,2,1,\"${NTUPLEDIR_5}/Zmm/Data/MuStaEff_tagPt/probes.root\",\"${OUTPUTDIR_5}/Zmm/Data/MuStaEff_aMCxPythia_tagPt${POSTFIX}/Combined\",\"png\",0,0,0,\"Muon\",\"stand-alone\",0.7,1.02,${LUMI5},\"${NTUPLEDIR_5}/Zmm/MC/MuStaEff_tagPt/probes.root\"\)
