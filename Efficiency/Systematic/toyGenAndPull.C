...
void toyGenAndPull(const TString tmpDir, // template for generating pseudodata (should be the alternate model)
        ...
        const Int_t nPsExp)
{
    ...
    TH1D* hdiff = new TH1D(outHistName, outHistName, 100, -0.001, 0.001);
