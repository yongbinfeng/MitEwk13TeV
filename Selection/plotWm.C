    ...
    )
{
    ...
    for (UInt_t ich = 0; ich < 3; ich++) {
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "p_{T}(#mu^{#pm}) [GeV/c]");
        if (ich == ePos)
            sprintf(xlabel, "p_{T}(#mu^{+}) [GeV/c]");
        if (ich == eNeg)
            sprintf(xlabel, "p_{T}(#mu^{-}) [GeV/c]");
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "#eta(#mu^{#pm})");
        if (ich == ePos)
            sprintf(xlabel, "#eta(#mu^{+})");
        if (ich == eNeg)
            sprintf(xlabel, "#eta(#mu^{-})");
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "#phi(#mu^{#pm})");
        if (ich == ePos)
            sprintf(xlabel, "#phi(#mu^{+})");
        if (ich == eNeg)
            sprintf(xlabel, "#phi(#mu^{-})");
        ...
        if (ich == eInc)
            sprintf(eventtext, "#mu^{#pm} events");
        if (ich == ePos)
            sprintf(eventtext, "#mu^{+} events");
        if (ich == eNeg)
            sprintf(eventtext, "#mu^{-} events");
