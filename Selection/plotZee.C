    ...
    )
{
    ...
    enum { eEleEle2HLT = 1,
        ...
        eEleEle1HLT,
        eEleEleNoSel,
        eEleSC }; // event category enumeration
    ...
    for (UInt_t icat = 0; icat < 6; icat++) {
        for (UInt_t isam = 0; isam < samplev.size(); isam++) {
            sprintf(hname, "hMass_cat%i_%i", icat, isam);
            hMassv[icat].push_back(new TH1D(hname, "", 30, 60, 120));
            hMassv[icat][isam]->Sumw2();
            sprintf(hname, "hPt1_cat%i_%i", icat, isam);
            hPt1v[icat].push_back(new TH1D(hname, "", 30, 0, 60));
            hPt1v[icat][isam]->Sumw2();
            sprintf(hname, "hPt2_cat%i_%i", icat, isam);
            hPt2v[icat].push_back(new TH1D(hname, "", 40, 0, 160));
            hPt2v[icat][isam]->Sumw2();
            sprintf(hname, "hy_cat%i_%i", icat, isam);
            hyv[icat].push_back(new TH1D(hname, "", 30, -3, 3));
            hyv[icat][isam]->Sumw2();
            sprintf(hname, "hPhi_cat%i_%i", icat, isam);
            hPhiv[icat].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hPhiv[icat][isam]->Sumw2();
            sprintf(hname, "hDPhi_cat%i_%i", icat, isam);
            hDPhiv[icat].push_back(new TH1D(hname, "", 40, 0, 3.2));
            hDPhiv[icat][isam]->Sumw2();
            sprintf(hname, "hDR_cat%i_%i", icat, isam);
            hDRv[icat].push_back(new TH1D(hname, "", 30, 0, 9));
            hDRv[icat][isam]->Sumw2();
            sprintf(hname, "hTagPt1_cat%i_%i", icat, isam);
            hTagPt1v[icat].push_back(new TH1D(hname, "", 30, 20, 80));
            hTagPt1v[icat][isam]->Sumw2();
            sprintf(hname, "hTagPt2_cat%i_%i", icat, isam);
            hTagPt2v[icat].push_back(new TH1D(hname, "", 40, 20, 180));
            hTagPt2v[icat][isam]->Sumw2();
            sprintf(hname, "hTagEta_cat%i_%i", icat, isam);
            hTagEtav[icat].push_back(new TH1D(hname, "", 30, -3, 3));
            hTagEtav[icat][isam]->Sumw2();
            sprintf(hname, "hTagPhi_cat%i_%i", icat, isam);
            hTagPhiv[icat].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hTagPhiv[icat][isam]->Sumw2();
            sprintf(hname, "hProbePt1_cat%i_%i", icat, isam);
            hProbePt1v[icat].push_back(new TH1D(hname, "", 30, 20, 80));
            hProbePt1v[icat][isam]->Sumw2();
            sprintf(hname, "hProbePt2_cat%i_%i", icat, isam);
            hProbePt2v[icat].push_back(new TH1D(hname, "", 40, 20, 180));
            hProbePt2v[icat][isam]->Sumw2();
            sprintf(hname, "hProbeEta_cat%i_%i", icat, isam);
            hProbeEtav[icat].push_back(new TH1D(hname, "", 30, -3, 3));
            hProbeEtav[icat][isam]->Sumw2();
            sprintf(hname, "hProbePhi_cat%i_%i", icat, isam);
            hProbePhiv[icat].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hProbePhiv[icat][isam]->Sumw2();
            sprintf(hname, "NPV_cat%i_%i", icat, isam);
            hNPVv[icat].push_back(new TH1D(hname, "", 30, -0.5, 29.5));
            hNPVv[icat][isam]->Sumw2();
        }
        sprintf(hname, "hMassMC_cat%i", icat);
        hMassMC[icat] = new TH1D(hname, "", 30, 60, 120);
        hMassMC[icat]->Sumw2();
        sprintf(hname, "hPt1MC_cat%i", icat);
        hPt1MC[icat] = new TH1D(hname, "", 30, 0, 60);
        hPt1MC[icat]->Sumw2();
        sprintf(hname, "hPt2MC_cat%i", icat);
        hPt2MC[icat] = new TH1D(hname, "", 40, 0, 160);
        hPt2MC[icat]->Sumw2();
        sprintf(hname, "hyMC_cat%i", icat);
        hyMC[icat] = new TH1D(hname, "", 30, -3, 3);
        hyMC[icat]->Sumw2();
        sprintf(hname, "hPhiMC_cat%i", icat);
        hPhiMC[icat] = new TH1D(hname, "", 40, -3.2, 3.2);
        hPhiMC[icat]->Sumw2();
        sprintf(hname, "hDPhiMC_cat%i", icat);
        hDPhiMC[icat] = new TH1D(hname, "", 40, 0, 3.2);
        hDPhiMC[icat]->Sumw2();
        sprintf(hname, "hDRMC_cat%i", icat);
        hDRMC[icat] = new TH1D(hname, "", 30, 0, 9);
        hDRMC[icat]->Sumw2();
        sprintf(hname, "hTagPt1MC_cat%i", icat);
        hTagPt1MC[icat] = new TH1D(hname, "", 30, 20, 80);
        hTagPt1MC[icat]->Sumw2();
        sprintf(hname, "hTagPt2MC_cat%i", icat);
        hTagPt2MC[icat] = new TH1D(hname, "", 40, 20, 180);
        hTagPt2MC[icat]->Sumw2();
        sprintf(hname, "hTagEtaMC_cat%i", icat);
        hTagEtaMC[icat] = new TH1D(hname, "", 30, -3, 3);
        hTagEtaMC[icat]->Sumw2();
        sprintf(hname, "hTagPhiMC_cat%i", icat);
        hTagPhiMC[icat] = new TH1D(hname, "", 40, -3.2, 3.2);
        hTagPhiMC[icat]->Sumw2();
        sprintf(hname, "hProbePt1MC_cat%i", icat);
        hProbePt1MC[icat] = new TH1D(hname, "", 30, 20, 80);
        hProbePt1MC[icat]->Sumw2();
        sprintf(hname, "hProbePt2MC_cat%i", icat);
        hProbePt2MC[icat] = new TH1D(hname, "", 40, 20, 180);
        hProbePt2MC[icat]->Sumw2();
        sprintf(hname, "hProbeEtaMC_cat%i", icat);
        hProbeEtaMC[icat] = new TH1D(hname, "", 30, -3, 3);
        hProbeEtaMC[icat]->Sumw2();
        sprintf(hname, "hProbePhiMC_cat%i", icat);
        hProbePhiMC[icat] = new TH1D(hname, "", 40, -3.2, 3.2);
        hProbePhiMC[icat]->Sumw2();
        sprintf(hname, "NPVMC_cat%i", icat);
        hNPVMC[icat] = new TH1D(hname, "", 30, -0.5, 29.5);
        hNPVMC[icat]->Sumw2();
    }

    vector<TH1D*> hMassBBv, hMassBEv, hMassEEv;
    for (UInt_t isam = 0; isam < samplev.size(); isam++) {
        sprintf(hname, "hMassBB_%i", isam);
        hMassBBv.push_back(new TH1D(hname, "", 30, 60, 120));
        hMassBBv[isam]->Sumw2();
        sprintf(hname, "hMassBE_%i", isam);
        hMassBEv.push_back(new TH1D(hname, "", 30, 60, 120));
        hMassBEv[isam]->Sumw2();
        sprintf(hname, "hMassEE_%i", isam);
        hMassEEv.push_back(new TH1D(hname, "", 30, 60, 120));
        hMassEEv[isam]->Sumw2();
    }
    TH1D* hMassBBMC = new TH1D("hMassBBMC", "", 30, 60, 120);
    hMassBBMC->Sumw2();
    TH1D* hMassBEMC = new TH1D("hMassBEMC", "", 30, 60, 120);
    hMassBEMC->Sumw2();
    TH1D* hMassEEMC = new TH1D("hMassEEMC", "", 30, 60, 120);
    hMassEEMC->Sumw2();
    ...
    for (UInt_t isam = 0; isam < samplev.size(); isam++) {
        ...
        for (UInt_t ientry = 0; ientry < intree->GetEntries(); ientry++) {
            ...
            if (dilep->M() < MASS_LOW)
                continue;
            if (dilep->M() > MASS_HIGH)
                continue;
            if (sc1->Pt() < PT_CUT)
                continue;
            if (sc2->Pt() < PT_CUT)
                continue;
            if (fabs(sc1->Eta()) > ETA_CUT)
                continue;
            if (fabs(sc2->Eta()) > ETA_CUT)
                continue;
    ...
    for (Int_t icat = 0; icat < 6; icat++) {
        sprintf(hname, "hMassDiff_cat%i", icat);
        hMassDiffv.push_back(makeDiffHist(hMassv[icat][0], hMassMC[icat], hname));
        sprintf(hname, "hPt1Diff_cat%i", icat);
        hPt1Diffv.push_back(makeDiffHist(hPt1v[icat][0], hPt1MC[icat], hname));
        sprintf(hname, "hPt2Diff_cat%i", icat);
        hPt2Diffv.push_back(makeDiffHist(hPt2v[icat][0], hPt2MC[icat], hname));
        sprintf(hname, "hyDiff_cat%i", icat);
        hyDiffv.push_back(makeDiffHist(hyv[icat][0], hyMC[icat], hname));
        sprintf(hname, "hPhiDiff_cat%i", icat);
        hPhiDiffv.push_back(makeDiffHist(hPhiv[icat][0], hPhiMC[icat], hname));
        sprintf(hname, "hDPhiDiff_cat%i", icat);
        hDPhiDiffv.push_back(makeDiffHist(hDPhiv[icat][0], hDPhiMC[icat], hname));
        sprintf(hname, "hDRDiff_cat%i", icat);
        hDRDiffv.push_back(makeDiffHist(hDRv[icat][0], hDRMC[icat], hname));
        sprintf(hname, "hTagPt1Diff_cat%i", icat);
        hTagPt1Diffv.push_back(makeDiffHist(hTagPt1v[icat][0], hTagPt1MC[icat], hname));
        sprintf(hname, "hTagPt2Diff_cat%i", icat);
        hTagPt2Diffv.push_back(makeDiffHist(hTagPt2v[icat][0], hTagPt2MC[icat], hname));
        sprintf(hname, "hTagEtaDiff_cat%i", icat);
        hTagEtaDiffv.push_back(makeDiffHist(hTagEtav[icat][0], hTagEtaMC[icat], hname));
        sprintf(hname, "hTagPhiDiff_cat%i", icat);
        hTagPhiDiffv.push_back(makeDiffHist(hTagPhiv[icat][0], hTagPhiMC[icat], hname));
        sprintf(hname, "hProbePt1Diff_cat%i", icat);
        hProbePt1Diffv.push_back(makeDiffHist(hProbePt1v[icat][0], hProbePt1MC[icat], hname));
        sprintf(hname, "hProbePt2Diff_cat%i", icat);
        hProbePt2Diffv.push_back(makeDiffHist(hProbePt2v[icat][0], hProbePt2MC[icat], hname));
        sprintf(hname, "hProbeEtaDiff_cat%i", icat);
        hProbeEtaDiffv.push_back(makeDiffHist(hProbeEtav[icat][0], hProbeEtaMC[icat], hname));
        sprintf(hname, "hProbePhiDiff_cat%i", icat);
        hProbePhiDiffv.push_back(makeDiffHist(hProbePhiv[icat][0], hProbePhiMC[icat], hname));
        sprintf(hname, "hNPVDiff_cat%i", icat);
        hNPVDiffv.push_back(makeDiffHist(hNPVv[icat][0], hNPVMC[icat], hname));
    }
    ...
    if (lumi < 0.01)
        sprintf(lumitext, "%.2f pb^{-1}  at  #sqrt{s} = 8 TeV", 1000. * lumi);
    else if (lumi < 0.1)
        sprintf(lumitext, "%.1f pb^{-1}  at  #sqrt{s} = 8 TeV", 1000. * lumi);
    else
        sprintf(lumitext, "%.0f fb^{-1}  at  #sqrt{s} = 8 TeV", lumi);
    ...
    for (UInt_t icat = 0; icat < 5; icat++) {
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading electron p_{T} [GeV/c]");
        else
            sprintf(xlabel, "tag electron p_{T} [GeV/c]");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading electron #eta");
        else
            sprintf(xlabel, "tag electron #eta");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading electron #phi");
        else
            sprintf(xlabel, "tag electron #phi");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing electron p_{T} [GeV/c]");
        else
            sprintf(xlabel, "probe electron p_{T} [GeV/c]");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing electron #eta");
        else
            sprintf(xlabel, "probe electron #eta");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing electron #phi");
        else
            sprintf(xlabel, "probe electron #phi");
