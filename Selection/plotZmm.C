    ...
    )
{
    ...
    for (UInt_t icat = 0; icat < 6; icat++) {
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading muon p_{T} [GeV/c]");
        else
            sprintf(xlabel, "tag muon p_{T} [GeV/c]");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading muon #eta");
        else
            sprintf(xlabel, "tag muon #eta");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "leading muon #phi");
        else
            sprintf(xlabel, "tag muon #phi");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing muon p_{T} [GeV/c]");
        else
            sprintf(xlabel, "probe muon p_{T} [GeV/c]");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing muon #eta");
        else
            sprintf(xlabel, "probe muon #eta");
        ...
        //
        if (icat == 0)
            sprintf(xlabel, "trailing muon #phi");
        else
            sprintf(xlabel, "probe muon #phi");
