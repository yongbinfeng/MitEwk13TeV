    ...
    )
{
    ...
    TFile* pufile = new TFile(pufname);
    assert(pufile);
    ...
    for (UInt_t ich = 0; ich < 3; ich++) {
        for (UInt_t isam = 0; isam < samplev.size(); isam++) {
            sprintf(hname, "hPt_ch%i_%i", ich, isam);
            hPtv[ich].push_back(new TH1D(hname, "", 30, 20, 80));
            hPtv[ich][isam]->Sumw2();
            sprintf(hname, "hPtB_ch%i_%i", ich, isam);
            hPtBv[ich].push_back(new TH1D(hname, "", 30, 20, 80));
            hPtBv[ich][isam]->Sumw2();
            sprintf(hname, "hPtE_ch%i_%i", ich, isam);
            hPtEv[ich].push_back(new TH1D(hname, "", 30, 20, 80));
            hPtEv[ich][isam]->Sumw2();
            sprintf(hname, "hPt2_ch%i_%i", ich, isam);
            hPt2v[ich].push_back(new TH1D(hname, "", 40, 20, 180));
            hPt2v[ich][isam]->Sumw2();
            sprintf(hname, "hPtB2_ch%i_%i", ich, isam);
            hPtB2v[ich].push_back(new TH1D(hname, "", 40, 20, 180));
            hPtB2v[ich][isam]->Sumw2();
            sprintf(hname, "hPtE2_ch%i_%i", ich, isam);
            hPtE2v[ich].push_back(new TH1D(hname, "", 40, 20, 180));
            hPtE2v[ich][isam]->Sumw2();
            sprintf(hname, "hEta_ch%i_%i", ich, isam);
            hEtav[ich].push_back(new TH1D(hname, "", 40, -3, 3));
            hEtav[ich][isam]->Sumw2();
            sprintf(hname, "hPhi_ch%i_%i", ich, isam);
            hPhiv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hPhiv[ich][isam]->Sumw2();
            sprintf(hname, "hPhiB_ch%i_%i", ich, isam);
            hPhiBv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hPhiBv[ich][isam]->Sumw2();
            sprintf(hname, "hPhiE_ch%i_%i", ich, isam);
            hPhiEv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hPhiEv[ich][isam]->Sumw2();
            sprintf(hname, "hMet_ch%i_%i", ich, isam);
            hMetv[ich].push_back(new TH1D(hname, "", 40, 0, 80));
            hMetv[ich][isam]->Sumw2();
            sprintf(hname, "hMetB_ch%i_%i", ich, isam);
            hMetBv[ich].push_back(new TH1D(hname, "", 40, 0, 80));
            hMetBv[ich][isam]->Sumw2();
            sprintf(hname, "hMetE_ch%i_%i", ich, isam);
            hMetEv[ich].push_back(new TH1D(hname, "", 40, 0, 80));
            hMetEv[ich][isam]->Sumw2();
            sprintf(hname, "hMet2_ch%i_%i", ich, isam);
            hMet2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMet2v[ich][isam]->Sumw2();
            sprintf(hname, "hMetB2_ch%i_%i", ich, isam);
            hMetB2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMetB2v[ich][isam]->Sumw2();
            sprintf(hname, "hMetE2_ch%i_%i", ich, isam);
            hMetE2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMetE2v[ich][isam]->Sumw2();
            sprintf(hname, "hMetPhi_ch%i_%i", ich, isam);
            hMetPhiv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hMetPhiv[ich][isam]->Sumw2();
            sprintf(hname, "hMetPhiB_ch%i_%i", ich, isam);
            hMetPhiBv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hMetPhiBv[ich][isam]->Sumw2();
            sprintf(hname, "hMetPhiE_ch%i_%i", ich, isam);
            hMetPhiEv[ich].push_back(new TH1D(hname, "", 40, -3.2, 3.2));
            hMetPhiEv[ich][isam]->Sumw2();
            sprintf(hname, "hMt_ch%i_%i", ich, isam);
            hMtv[ich].push_back(new TH1D(hname, "", 40, 0, 120));
            hMtv[ich][isam]->Sumw2();
            sprintf(hname, "hMtB_ch%i_%i", ich, isam);
            hMtBv[ich].push_back(new TH1D(hname, "", 40, 0, 120));
            hMtBv[ich][isam]->Sumw2();
            sprintf(hname, "hMtE_ch%i_%i", ich, isam);
            hMtEv[ich].push_back(new TH1D(hname, "", 40, 0, 120));
            hMtEv[ich][isam]->Sumw2();
            sprintf(hname, "hMt2_ch%i_%i", ich, isam);
            hMt2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMt2v[ich][isam]->Sumw2();
            sprintf(hname, "hMtB2_ch%i_%i", ich, isam);
            hMtB2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMtB2v[ich][isam]->Sumw2();
            sprintf(hname, "hMtE2_ch%i_%i", ich, isam);
            hMtE2v[ich].push_back(new TH1D(hname, "", 40, 0, 200));
            hMtE2v[ich][isam]->Sumw2();
            sprintf(hname, "hNPV_ch%i_%i", ich, isam);
            hNPVv[ich].push_back(new TH1D(hname, "", 30, -0.5, 29.5));
            hNPVv[ich][isam]->Sumw2();
        }
        sprintf(hname, "hPtMC_ch%i", ich);
        hPtMC[ich] = new TH1D(hname, "", 30, 20, 80);
        hPtMC[ich]->Sumw2();
        sprintf(hname, "hPtBMC_ch%i", ich);
        hPtBMC[ich] = new TH1D(hname, "", 30, 20, 80);
        hPtBMC[ich]->Sumw2();
        sprintf(hname, "hPtEMC_ch%i", ich);
        hPtEMC[ich] = new TH1D(hname, "", 30, 20, 80);
        hPtEMC[ich]->Sumw2();
        sprintf(hname, "hPt2MC_ch%i", ich);
        hPt2MC[ich] = new TH1D(hname, "", 40, 20, 180);
        hPt2MC[ich]->Sumw2();
        sprintf(hname, "hPtB2MC_ch%i", ich);
        hPtB2MC[ich] = new TH1D(hname, "", 40, 20, 180);
        hPtB2MC[ich]->Sumw2();
        sprintf(hname, "hPtE2MC_ch%i", ich);
        hPtE2MC[ich] = new TH1D(hname, "", 40, 20, 180);
        hPtE2MC[ich]->Sumw2();
        sprintf(hname, "hEtaMC_ch%i", ich);
        hEtaMC[ich] = new TH1D(hname, "", 40, -3, 3);
        hEtaMC[ich]->Sumw2();
        sprintf(hname, "hPhiMC_ch%i", ich);
        hPhiMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hPhiMC[ich]->Sumw2();
        sprintf(hname, "hPhiBMC_ch%i", ich);
        hPhiBMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hPhiBMC[ich]->Sumw2();
        sprintf(hname, "hPhiEMC_ch%i", ich);
        hPhiEMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hPhiEMC[ich]->Sumw2();
        sprintf(hname, "hMetMC_ch%i", ich);
        hMetMC[ich] = new TH1D(hname, "", 40, 0, 80);
        hMetMC[ich]->Sumw2();
        sprintf(hname, "hMetBMC_ch%i", ich);
        hMetBMC[ich] = new TH1D(hname, "", 40, 0, 80);
        hMetBMC[ich]->Sumw2();
        sprintf(hname, "hMetEMC_ch%i", ich);
        hMetEMC[ich] = new TH1D(hname, "", 40, 0, 80);
        hMetEMC[ich]->Sumw2();
        sprintf(hname, "hMet2MC_ch%i", ich);
        hMet2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMet2MC[ich]->Sumw2();
        sprintf(hname, "hMetB2MC_ch%i", ich);
        hMetB2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMetB2MC[ich]->Sumw2();
        sprintf(hname, "hMetE2MC_ch%i", ich);
        hMetE2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMetE2MC[ich]->Sumw2();
        sprintf(hname, "hMetPhiMC_ch%i", ich);
        hMetPhiMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hMetPhiMC[ich]->Sumw2();
        sprintf(hname, "hMetPhiBMC_ch%i", ich);
        hMetPhiBMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hMetPhiBMC[ich]->Sumw2();
        sprintf(hname, "hMetPhiEMC_ch%i", ich);
        hMetPhiEMC[ich] = new TH1D(hname, "", 40, -3.2, 3.2);
        hMetPhiEMC[ich]->Sumw2();
        sprintf(hname, "hMtMC_ch%i", ich);
        hMtMC[ich] = new TH1D(hname, "", 40, 0, 120);
        hMtMC[ich]->Sumw2();
        sprintf(hname, "hMtBMC_ch%i", ich);
        hMtBMC[ich] = new TH1D(hname, "", 40, 0, 120);
        hMtBMC[ich]->Sumw2();
        sprintf(hname, "hMtEMC_ch%i", ich);
        hMtEMC[ich] = new TH1D(hname, "", 40, 0, 120);
        hMtEMC[ich]->Sumw2();
        sprintf(hname, "hMt2MC_ch%i", ich);
        hMt2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMt2MC[ich]->Sumw2();
        sprintf(hname, "hMtB2MC_ch%i", ich);
        hMtB2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMtB2MC[ich]->Sumw2();
        sprintf(hname, "hMtE2MC_ch%i", ich);
        hMtE2MC[ich] = new TH1D(hname, "", 40, 0, 200);
        hMtE2MC[ich]->Sumw2();
        sprintf(hname, "hNPVMC_ch%i", ich);
        hNPVMC[ich] = new TH1D(hname, "", 30, -0.5, 29.5);
        hNPVMC[ich]->Sumw2();
    }
    ...
    for (Int_t ich = 0; ich < 3; ich++) {
        sprintf(hname, "hPtDiff_ch%i", ich);
        hPtDiffv.push_back(makeDiffHist(hPtv[ich][0], hPtMC[ich], hname));
        sprintf(hname, "hPtBDiff_ch%i", ich);
        hPtBDiffv.push_back(makeDiffHist(hPtBv[ich][0], hPtBMC[ich], hname));
        sprintf(hname, "hPtEDiff_ch%i", ich);
        hPtEDiffv.push_back(makeDiffHist(hPtEv[ich][0], hPtEMC[ich], hname));
        sprintf(hname, "hPt2Diff_ch%i", ich);
        hPt2Diffv.push_back(makeDiffHist(hPt2v[ich][0], hPt2MC[ich], hname));
        sprintf(hname, "hPtB2Diff_ch%i", ich);
        hPtB2Diffv.push_back(makeDiffHist(hPtB2v[ich][0], hPtB2MC[ich], hname));
        sprintf(hname, "hPtE2Diff_ch%i", ich);
        hPtE2Diffv.push_back(makeDiffHist(hPtE2v[ich][0], hPtE2MC[ich], hname));
        sprintf(hname, "hEtaDiff_ch%i", ich);
        hEtaDiffv.push_back(makeDiffHist(hEtav[ich][0], hEtaMC[ich], hname));
        sprintf(hname, "hPhiDiff_ch%i", ich);
        hPhiDiffv.push_back(makeDiffHist(hPhiv[ich][0], hPhiMC[ich], hname));
        sprintf(hname, "hPhiBDiff_ch%i", ich);
        hPhiBDiffv.push_back(makeDiffHist(hPhiBv[ich][0], hPhiBMC[ich], hname));
        sprintf(hname, "hPhiEDiff_ch%i", ich);
        hPhiEDiffv.push_back(makeDiffHist(hPhiEv[ich][0], hPhiEMC[ich], hname));
        sprintf(hname, "hMetDiff_ch%i", ich);
        hMetDiffv.push_back(makeDiffHist(hMetv[ich][0], hMetMC[ich], hname));
        sprintf(hname, "hMetBDiff_ch%i", ich);
        hMetBDiffv.push_back(makeDiffHist(hMetBv[ich][0], hMetBMC[ich], hname));
        sprintf(hname, "hMetEDiff_ch%i", ich);
        hMetEDiffv.push_back(makeDiffHist(hMetEv[ich][0], hMetEMC[ich], hname));
        sprintf(hname, "hMet2Diff_ch%i", ich);
        hMet2Diffv.push_back(makeDiffHist(hMet2v[ich][0], hMet2MC[ich], hname));
        sprintf(hname, "hMetB2Diff_ch%i", ich);
        hMetB2Diffv.push_back(makeDiffHist(hMetB2v[ich][0], hMetB2MC[ich], hname));
        sprintf(hname, "hMetE2Diff_ch%i", ich);
        hMetE2Diffv.push_back(makeDiffHist(hMetE2v[ich][0], hMetE2MC[ich], hname));
        sprintf(hname, "hMetPhiDiff_ch%i", ich);
        hMetPhiDiffv.push_back(makeDiffHist(hMetPhiv[ich][0], hMetPhiMC[ich], hname));
        sprintf(hname, "hMetPhiBDiff_ch%i", ich);
        hMetPhiBDiffv.push_back(makeDiffHist(hMetPhiBv[ich][0], hMetPhiBMC[ich], hname));
        sprintf(hname, "hMetPhiEDiff_ch%i", ich);
        hMetPhiEDiffv.push_back(makeDiffHist(hMetPhiEv[ich][0], hMetPhiEMC[ich], hname));
        sprintf(hname, "hMtDiff_ch%i", ich);
        hMtDiffv.push_back(makeDiffHist(hMtv[ich][0], hMtMC[ich], hname));
        sprintf(hname, "hMtBDiff_ch%i", ich);
        hMtBDiffv.push_back(makeDiffHist(hMtBv[ich][0], hMtBMC[ich], hname));
        sprintf(hname, "hMtEDiff_ch%i", ich);
        hMtEDiffv.push_back(makeDiffHist(hMtEv[ich][0], hMtEMC[ich], hname));
        sprintf(hname, "hMt2Diff_ch%i", ich);
        hMt2Diffv.push_back(makeDiffHist(hMt2v[ich][0], hMt2MC[ich], hname));
        sprintf(hname, "hMtB2Diff_ch%i", ich);
        hMtB2Diffv.push_back(makeDiffHist(hMtB2v[ich][0], hMtB2MC[ich], hname));
        sprintf(hname, "hMtE2Diff_ch%i", ich);
        hMtE2Diffv.push_back(makeDiffHist(hMtE2v[ich][0], hMtE2MC[ich], hname));
        sprintf(hname, "hNPVDiff_ch%i", ich);
        hNPVDiffv.push_back(makeDiffHist(hNPVv[ich][0], hNPVMC[ich], hname));
    }
    ...
    if (lumi < 0.1)
        sprintf(lumitext, "#int#font[12]{L}dt = %.1f pb^{-1}", 1000. * lumi);
    else if (lumi < 1)
        sprintf(lumitext, "#int#font[12]{L}dt = %.0f pb^{-1}", 1000. * lumi);
    else
        sprintf(lumitext, "#int#font[12]{L}dt = %.2f fb^{-1}", lumi);
    ...
    for (UInt_t ich = 0; ich < 3; ich++) {
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "p_{T}(e^{#pm}) [GeV/c]");
        if (ich == ePos)
            sprintf(xlabel, "p_{T}(e^{+}) [GeV/c]");
        if (ich == eNeg)
            sprintf(xlabel, "p_{T}(e^{-}) [GeV/c]");
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "#eta(e^{#pm})");
        if (ich == ePos)
            sprintf(xlabel, "#eta(e^{+})");
        if (ich == eNeg)
            sprintf(xlabel, "#eta(e^{-})");
        ...
        //
        if (ich == eInc)
            sprintf(xlabel, "#phi(e^{#pm})");
        if (ich == ePos)
            sprintf(xlabel, "#phi(e^{+})");
        if (ich == eNeg)
            sprintf(xlabel, "#phi(e^{-})");
        ...
        if (ich == eInc)
            sprintf(eventtext, "e^{#pm} events");
        if (ich == ePos)
            sprintf(eventtext, "e^{+} events");
        if (ich == eNeg)
            sprintf(eventtext, "e^{-} events");
...
TH1D* makeDiffHist(TH1D* hData, TH1D* hMC, const TString name)
{
    ...
    for (Int_t ibin = 1; ibin <= hData->GetNbinsX(); ibin++) {
        ...
        if (err == 0)
            err = sqrt(hMC->GetBinContent(ibin));

        if (err > 0)
            hDiff->SetBinContent(ibin, diff / err);
        else
...
void makeHTML(const TString outDir)
{
    ...
    for (UInt_t ich = 0; ich < 3; ich++) {
        if (ich == 0)
            htmlfile << "<h3 style=\"text-align:left; color:DD6600;\"><a target=\"_blank\" href=\"w_all.html\">W<sup>&plusmn;</sup></a></h3>" << endl;
        if (ich == 1)
            htmlfile << "<h3 style=\"text-align:left; color:DD6600;\"><a target=\"_blank\" href=\"w_pos.html\">W<sup>+</sup></a></h3>" << endl;
        if (ich == 2)
            htmlfile << "<h3 style=\"text-align:left; color:DD6600;\"><a target=\"_blank\" href=\"w_neg.html\">W<sup>-</sup></a></h3>" << endl;
    ...
    for (UInt_t ich = 0; ich < 3; ich++) {
        if (ich == 0)
            sprintf(htmlfname, "%s/w_all.html", outDir.Data());
        if (ich == 1)
            sprintf(htmlfname, "%s/w_pos.html", outDir.Data());
        if (ich == 2)
            sprintf(htmlfname, "%s/w_neg.html", outDir.Data());
