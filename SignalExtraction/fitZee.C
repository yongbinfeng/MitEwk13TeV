    ...
    )
{
    ...
    for (int j = 0; j < nWeight; ++j) {
        ...
        sprintf(hname, "hZee_%s", (vWeight[j]).c_str());
        hZeeUnc[j] = new TH1D(hname, "", NBINS, MASS_LOW, MASS_HIGH);
    ...
    TH1D* hDataUp = new TH1D("hDataUp", "", NBINS, MASS_LOW, MASS_HIGH);
    hDataUp->Sumw2();
    TH1D* hZeeUp = new TH1D("hZeeUp", "", NBINS, MASS_LOW, MASS_HIGH);
    hZeeUp->Sumw2();

    TH1D* hDataDown = new TH1D("hDataDown", "", NBINS, MASS_LOW, MASS_HIGH);
    hDataDown->Sumw2();
    TH1D* hZeeDown = new TH1D("hZeeDown", "", NBINS, MASS_LOW, MASS_HIGH);
    hZeeDown->Sumw2();
