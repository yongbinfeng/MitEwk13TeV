    ...
    )
{
    ...
    enum { eData,
        ...
        eAntiDib,
        eAntiWx,
        eAntiZxx }; // data type enum
    vector<TString> fnamev;
    vector<Int_t> typev;

    if (lumi < 250) {
        if (flav.CompareTo("Wenu") == 0) {
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/we0_select.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/we1_select.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/we2_select.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx0_select.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx1_select.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx2_select.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zxx_select.root"));
            typev.push_back(eZxx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zz_select.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/ww_select.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wz_select.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top1_select.root"));
            typev.push_back(eTtb);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top2_select.root"));
            typev.push_back(eTtb);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top3_select.root"));
            typev.push_back(eTtb);

            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/we0_select.root"));
            typev.push_back(eAntiWlnu);
            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/we1_select.root"));
            typev.push_back(eAntiWlnu);
            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/we2_select.root"));
            typev.push_back(eAntiWlnu);

        } else if (flav.CompareTo("Wmunu") == 0) {
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wm0_select.raw.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wm1_select.raw.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wm2_select.raw.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx0_select.raw.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx1_select.raw.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx2_select.raw.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zxx_select.raw.root"));
            typev.push_back(eZxx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zz_select.raw.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/ww_select.raw.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wz_select.raw.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top1_select.raw.root"));
            typev.push_back(eTtb);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top2_select.raw.root"));
            typev.push_back(eTtb);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top3_select.raw.root"));
            typev.push_back(eTtb);

            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wm0_select.root"));
            typev.push_back(eAntiWlnu);
            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wm1_select.root"));
            typev.push_back(eAntiWlnu);
            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wm2_select.root"));
            typev.push_back(eAntiWlnu);
        }

        fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/data_select.root"));
        typev.push_back(eData);

        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/data_select.root"));
        typev.push_back(eAntiData);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wx0_select.root"));
        typev.push_back(eAntiWx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wx1_select.root"));
        typev.push_back(eAntiWx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wx2_select.root"));
        typev.push_back(eAntiWx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/zxx_select.root"));
        typev.push_back(eAntiZxx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/ww_select.root"));
        typev.push_back(eAntiDib);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wz_select.root"));
        typev.push_back(eAntiDib);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/zz_select.root"));
        typev.push_back(eAntiDib);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/top1_select.root"));
        typev.push_back(eAntiTtb);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/top2_select.root"));
        typev.push_back(eAntiTtb);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/top3_select.root"));
        typev.push_back(eAntiTtb);
    }

    if (lumi > 250) { // The 5 TeV
        if (flav.CompareTo("Wmunu") == 0) {
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wm_select.raw.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/data_select.root"));
            typev.push_back(eData);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx_select.raw.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zxx_select.raw.root"));
            typev.push_back(eZxx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zz_select.raw.root"));
            ...
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wz_select.raw.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top_select.raw.root"));
            typev.push_back(eTtb);

            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wm_select.root"));
            typev.push_back(eAntiWlnu);
        } else if (flav.CompareTo("Wenu") == 0) {
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/we_select.root"));
            typev.push_back(eWlnu);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/data_select.root"));
            typev.push_back(eData);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wx_select.root"));
            typev.push_back(eWx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zxx_select.root"));
            typev.push_back(eZxx);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/zz_select.root"));
            ...
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/wz_select.root"));
            typev.push_back(eDib);
            fnamev.push_back(ntupleDir + TString("/") + flav + TString("/ntuples/top_select.root"));
            typev.push_back(eTtb);

            fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/we_select.root"));
            typev.push_back(eAntiWlnu);
        }

        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/data_select.root"));
        typev.push_back(eAntiData);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/wx_select.root"));
        typev.push_back(eAntiWx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/zxx_select.root"));
        typev.push_back(eAntiZxx);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/ww_select.root"));
        ...
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/zz_select.root"));
        typev.push_back(eAntiDib);
        fnamev.push_back(ntupleDir + TString("/Anti") + flav + TString("/ntuples/top_select.root"));
        typev.push_back(eAntiTtb);
    }
    ...
    TH1D*** hWlnupMETU = new TH1D**[nIsoBins];
    TH1D*** hWlnumMETU = new TH1D**[nIsoBins];
    TH1D*** hWlnupMETD = new TH1D**[nIsoBins];
    TH1D*** hWlnumMETD = new TH1D**[nIsoBins];

    TH1D*** hEWKpMETU = new TH1D**[nIsoBins];
    TH1D*** hEWKmMETU = new TH1D**[nIsoBins];
    TH1D*** hEWKpMETD = new TH1D**[nIsoBins];
    TH1D*** hEWKmMETD = new TH1D**[nIsoBins];

    TH1D*** hWxpMETU = new TH1D**[nIsoBins];
    TH1D*** hWxmMETU = new TH1D**[nIsoBins];
    TH1D*** hWxpMETD = new TH1D**[nIsoBins];
    TH1D*** hWxmMETD = new TH1D**[nIsoBins];

    TH1D*** hZxxpMETU = new TH1D**[nIsoBins];
    TH1D*** hZxxmMETU = new TH1D**[nIsoBins];
    TH1D*** hZxxpMETD = new TH1D**[nIsoBins];
    TH1D*** hZxxmMETD = new TH1D**[nIsoBins];
    ////////////////////////////////////////////////////////////////////////////////////////
    TH1D*** hWlnupWeightU = new TH1D**[nIsoBins];
    TH1D*** hWlnumWeightU = new TH1D**[nIsoBins];
    TH1D*** hWlnupWeightD = new TH1D**[nIsoBins];
    TH1D*** hWlnumWeightD = new TH1D**[nIsoBins];

    TH1D*** hEWKpWeightU = new TH1D**[nIsoBins];
    TH1D*** hEWKmWeightU = new TH1D**[nIsoBins];
    TH1D*** hEWKpWeightD = new TH1D**[nIsoBins];
    TH1D*** hEWKmWeightD = new TH1D**[nIsoBins];

    TH1D*** hWxpWeightU = new TH1D**[nIsoBins];
    TH1D*** hWxmWeightU = new TH1D**[nIsoBins];
    TH1D*** hWxpWeightD = new TH1D**[nIsoBins];
    TH1D*** hWxmWeightD = new TH1D**[nIsoBins];

    TH1D*** hZxxpWeightU = new TH1D**[nIsoBins];
    TH1D*** hZxxmWeightU = new TH1D**[nIsoBins];
    TH1D*** hZxxpWeightD = new TH1D**[nIsoBins];
    TH1D*** hZxxmWeightD = new TH1D**[nIsoBins];

    TH1D*** hDibpWeightU = new TH1D**[nIsoBins];
    TH1D*** hDibmWeightU = new TH1D**[nIsoBins];
    TH1D*** hDibpWeightD = new TH1D**[nIsoBins];
    TH1D*** hDibmWeightD = new TH1D**[nIsoBins];

    TH1D*** hTtbpWeightU = new TH1D**[nIsoBins];
    TH1D*** hTtbmWeightU = new TH1D**[nIsoBins];
    TH1D*** hTtbpWeightD = new TH1D**[nIsoBins];
    TH1D*** hTtbmWeightD = new TH1D**[nIsoBins];
    ...
    for (UInt_t ifile = 0; ifile < fnamev.size(); ifile++) {
        ...
        for (UInt_t ientry = 0; ientry < intree->GetEntries(); ientry++) {
            ...
            } else if (doTransversMass)
                (*metVars)[no] = mtCorr;

            if (doMTCut && (mtCorr < MT_CUT))
                continue; //std::cout << " pass mt " << std::endl;
    ...
    txtfilePF << "PF (photon only): " << prefirePhoton_Wp << "  scale factor: " << noPrefire_Wp / prefirePhoton_Wp << endl
              << endl;
    txtfilePF << "---- W- ----- " << endl;
    ...
    txtfilePF << "PF (photon only): " << prefirePhoton_Wm << "  scale factor: " << noPrefire_Wm / prefirePhoton_Wm << endl
              << endl;
    txtfilePF.close();
    ...
    for (int j = 0; j < nIsoBins; ++j) {
        ...
        for (int k = 0; k < nMET; ++k) {
            ...
            hh_diff = (TH1D*)hWlnupMETU[j][k]->Clone("diff");
            hh_diff->Add(hWlnuMetp2d[j], -1);
            hWlnupMETD[j][k] = (TH1D*)hWlnuMetp2d[j]->Clone(nname);
            hWlnupMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWlnuMetmBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hWlnumMETU[j][k]->Clone("diff");
            hh_diff->Add(hWlnuMetm2d[j], -1);
            hWlnumMETD[j][k] = (TH1D*)hWlnuMetm2d[j]->Clone(nname);
            hWlnumMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWEwkMetpBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hEWKpMETU[j][k]->Clone("diff");
            hh_diff->Add(hEWKMetp2d[j], -1);
            hEWKpMETD[j][k] = (TH1D*)hEWKMetp2d[j]->Clone(nname);
            hEWKpMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hEwkMetmBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hEWKmMETU[j][k]->Clone("diff");
            hh_diff->Add(hEWKMetm2d[j], -1);
            hEWKmMETD[j][k] = (TH1D*)hEWKMetm2d[j]->Clone(nname);
            hEWKmMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWxMetpBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hWxpMETU[j][k]->Clone("diff");
            hh_diff->Add(hWxMetp2d[j], -1);
            hWxpMETD[j][k] = (TH1D*)hWxMetp2d[j]->Clone(nname);
            hWxpMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWxMetmBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hWxmMETU[j][k]->Clone("diff");
            hh_diff->Add(hWxMetm2d[j], -1);
            hWxmMETD[j][k] = (TH1D*)hWxMetm2d[j]->Clone(nname);
            hWxmMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hZxxMetpBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hZxxpMETU[j][k]->Clone("diff");
            hh_diff->Add(hZxxMetp2d[j], -1);
            hZxxpMETD[j][k] = (TH1D*)hZxxMetp2d[j]->Clone(nname);
            hZxxpMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hZxxMetmBin%d_%sDown", j, vMET[k].c_str());
            hh_diff = (TH1D*)hZxxmMETU[j][k]->Clone("diff");
            hh_diff->Add(hZxxMetm2d[j], -1);
            hZxxmMETD[j][k] = (TH1D*)hZxxMetm2d[j]->Clone(nname);
            hZxxmMETD[j][k]->Add(hh_diff, -1); //delete hh_diff;
        }

        for (int k = 0; k < nWeight; ++k) {
            if (k == pfireu || k == pfired)
                continue;
            // sprintf(type,"%i_prefireDown",i);

            sprintf(nname, "hWlnuMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hWlnupWeightU[j][k]->Clone("diff");
            hh_diff->Add(hWlnuMetp2d[j], -1);
            hWlnupWeightD[j][k] = (TH1D*)hWlnuMetp2d[j]->Clone(nname);
            hWlnupWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWlnuMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hWlnumWeightU[j][k]->Clone("diff");
            hh_diff->Add(hWlnuMetm2d[j], -1);
            hWlnumWeightD[j][k] = (TH1D*)hWlnuMetm2d[j]->Clone(nname);
            hWlnumWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hEwkMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hEWKpWeightU[j][k]->Clone("diff");
            hh_diff->Add(hEWKMetp2d[j], -1);
            hEWKpWeightD[j][k] = (TH1D*)hEWKMetp2d[j]->Clone(nname);
            hEWKpWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hEwkMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hEWKmWeightU[j][k]->Clone("diff");
            hh_diff->Add(hEWKMetm2d[j], -1);
            hEWKmWeightD[j][k] = (TH1D*)hEWKMetm2d[j]->Clone(nname);
            hEWKmWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWxMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hWxpWeightU[j][k]->Clone("diff");
            hh_diff->Add(hWxMetp2d[j], -1);
            hWxpWeightD[j][k] = (TH1D*)hWxMetp2d[j]->Clone(nname);
            hWxpWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hWxMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hWxmWeightU[j][k]->Clone("diff");
            hh_diff->Add(hWxMetm2d[j], -1);
            hWxmWeightD[j][k] = (TH1D*)hWxMetm2d[j]->Clone(nname);
            hWxmWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hZxxMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hZxxpWeightU[j][k]->Clone("diff");
            hh_diff->Add(hZxxMetp2d[j], -1);
            hZxxpWeightD[j][k] = (TH1D*)hZxxMetp2d[j]->Clone(nname);
            hZxxpWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hZxxMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hZxxmWeightU[j][k]->Clone("diff");
            hh_diff->Add(hZxxMetm2d[j], -1);
            hZxxmWeightD[j][k] = (TH1D*)hZxxMetm2d[j]->Clone(nname);
            hZxxmWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hDibMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hDibpWeightU[j][k]->Clone("diff");
            hh_diff->Add(hDibMetp2d[j], -1);
            hDibpWeightD[j][k] = (TH1D*)hDibMetp2d[j]->Clone(nname);
            hDibpWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hDibMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hDibmWeightU[j][k]->Clone("diff");
            hh_diff->Add(hDibMetm2d[j], -1);
            hDibmWeightD[j][k] = (TH1D*)hDibMetm2d[j]->Clone(nname);
            hDibmWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hTtbMetpBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hTtbpWeightU[j][k]->Clone("diff");
            hh_diff->Add(hTtbMetp2d[j], -1);
            hTtbpWeightD[j][k] = (TH1D*)hTtbMetp2d[j]->Clone(nname);
            hTtbpWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;

            sprintf(nname, "hTtbMetmBin%d_%sDown", j, vWeight[k].c_str());
            hh_diff = (TH1D*)hTtbmWeightU[j][k]->Clone("diff");
            hh_diff->Add(hTtbMetm2d[j], -1);
            hTtbmWeightD[j][k] = (TH1D*)hTtbMetm2d[j]->Clone(nname);
            hTtbmWeightD[j][k]->Add(hh_diff, -1); //delete hh_diff;
        }
    }
    ...
    // Fill the histograms
    //////////////////////////////////////////////////////////////////////////
    TH1* qcdp2 = (TH1*)hQCDMetp2d[2]->Clone();
    TH1* qcdp3 = (TH1*)hQCDMetp2d[3]->Clone();
    TH1* qcdm2 = (TH1*)hQCDMetm2d[2]->Clone();
    TH1* qcdm3 = (TH1*)hQCDMetm2d[3]->Clone();
    ...
    RooDataHist WlnuMetp("WlnuMETp", "WlnuMETp", RooArgSet(pfmet), hWlnuMetp2d[0]);
    RooHistPdf pdfWmp("wmp", "wmp", pfmet, WlnuMetp, 1);
    RooDataHist WlnuMetm("WlnuMETm", "WlnuMETm", RooArgSet(pfmet), hWlnuMetm2d[0]);
    RooHistPdf pdfWmm("wmm", "wmm", pfmet, WlnuMetm, 1);

    RooDataHist ewkMetp("ewkMETp", "ewkMETp", RooArgSet(pfmet), hEWKMetp2d[0]);
    RooHistPdf pdfEWKp("ewkp", "ewkp", pfmet, ewkMetp, 1);
    RooDataHist ewkMetm("ewkMETm", "ewkMETm", RooArgSet(pfmet), hEWKMetm2d[0]);
    RooHistPdf pdfEWKm("ewkm", "ewkm", pfmet, ewkMetm, 1);

    RooDataHist qcdMetp("qcdMetp", "qcdMetp", RooArgSet(pfmet), hQCDMetp2d[0]);
    RooHistPdf pdfQCDp("qcdp", "qcdp", pfmet, qcdMetp, 1);
    RooDataHist qcdMetm("qcdMetm", "qcdMetm", RooArgSet(pfmet), hQCDMetm2d[0]);
    RooHistPdf pdfQCDm("qcdm", "qcdm", pfmet, qcdMetm, 1);
    ...
    if (lumi > 200)
        sprintf(lumitext, "%.1f pb^{-1}  (5 TeV)", lumi);
    else
        sprintf(lumitext, "%.1f pb^{-1}  (13 TeV)", lumi);

    TH1D* hPdfMetp = (TH1D*)pdfMetp.createHistogram("hPdfMetp", pfmet);
    for (int ibin = 1; ibin < hPdfMetp->GetNbinsX(); ++ibin) {
        hPdfMetp->SetBinError(ibin, hWlnuMetp2d[0]->GetBinError(ibin));
    }
    ...
    for (int ibin = 1; ibin < hPdfMetm->GetNbinsX(); ++ibin) {
        hPdfMetm->SetBinError(ibin, hWlnuMetm2d[0]->GetBinError(ibin));
    }
...
{
    char nname[100];
    sprintf(nname, "%s%d%s", dh.c_str(), it, sfx.c_str());
    vDataHist[it] = new RooDataHist(nname, nname, RooArgSet(x), hIn);
    sprintf(nname, "%s%d%s", hp.c_str(), it, sfx.c_str());
    vHistPdf[it] = new RooHistPdf(nname, nname, x, *vDataHist[it], 1);
    return;
}
