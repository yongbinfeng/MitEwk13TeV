    ...
    )
{
    ...
    fnamev.push_back(inputDir + TString("/") + TString("zmm_select.raw.root"));
    typev.push_back(eZmm);
    fnamev.push_back(inputDir + TString("/") + TString("wx0_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("wx1_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("wx2_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("zxx_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("wz_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("ww_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("zz_select.raw.root"));
    typev.push_back(eEWK);
    fnamev.push_back(inputDir + TString("/") + TString("top1_select.raw.root"));
    typev.push_back(eTop);
    fnamev.push_back(inputDir + TString("/") + TString("top2_select.raw.root"));
    typev.push_back(eTop);
    fnamev.push_back(inputDir + TString("/") + TString("top3_select.raw.root"));
    typev.push_back(eTop);
    ...
    typev.push_back(eWx);
    fnamev.push_back(inputDir + TString("/") + TString("zxx_select.raw.root"));
    typev.push_back(eZxx);
    fnamev.push_back(inputDir + TString("/") + TString("ww_select.raw.root"));
    typev.push_back(eDib);
    fnamev.push_back(inputDir + TString("/") + TString("wz_select.raw.root"));
    typev.push_back(eDib);
    fnamev.push_back(inputDir + TString("/") + TString("zz_select.raw.root"));
    typev.push_back(eDib);
    ...
    hData->Sumw2();
    TH1D* hZmm = new TH1D("hZmm", "", NBINS, MASS_LOW, MASS_HIGH);
    hZmm->Sumw2();
    ...
    hDataNPV->Sumw2();
    TH1D* hZmmNPV = new TH1D("hZmmNPV", "", 50, 0, 50);
    hZmmNPV->Sumw2();
    ...
    hDataZPt->Sumw2();
    TH1D* hZmmZPt = new TH1D("hZmmZPt", "", nBinsZPt, ZPtBins);
    hZmmZPt->Sumw2();
    ...
    hDataPhiStar->Sumw2();
    TH1D* hZmmPhiStar = new TH1D("hZmmPhiStar", "", nBinsPhiStar, PhiStarBins);
    hZmmPhiStar->Sumw2();
    ...
    hDataZRap->Sumw2();
    TH1D* hZmmZRap = new TH1D("hZmmZRap", "", 24, 0, 2.4);
    hZmmZRap->Sumw2();
    ...
    hDataLep1Pt->Sumw2();
    TH1D* hZmmLep1Pt = new TH1D("hZmmLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hZmmLep1Pt->Sumw2();
    ...
    hDataLep2Pt->Sumw2();
    TH1D* hZmmLep2Pt = new TH1D("hZmmLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hZmmLep2Pt->Sumw2();
    ...
    hDataLepNegPt->Sumw2();
    TH1D* hZmmLepNegPt = new TH1D("hZmmLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hZmmLepNegPt->Sumw2();
    ...
    hDataLepPosPt->Sumw2();
    TH1D* hZmmLepPosPt = new TH1D("hZmmLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hZmmLepPosPt->Sumw2();
    ...
    hDataLep1Eta->Sumw2();
    TH1D* hZmmLep1Eta = new TH1D("hZmmLep1Eta", "", 24, 0, 2.4);
    hZmmLep1Eta->Sumw2();
    ...
    hDataLep2Eta->Sumw2();
    TH1D* hZmmLep2Eta = new TH1D("hZmmLep2Eta", "", 24, 0, 2.4);
    hZmmLep2Eta->Sumw2();
        ...
        for (UInt_t ientry = 0; ientry < intree->GetEntries(); ientry++) {
            ...
            if (typev[ifile] == eData) {
                ...
                if (genlep1->Pt() == 0 && genlep2->Pt() == 0) {
                    mcSF1 = 1;
                    mcSF2 = 1;
                } // stupid gen shit for ttbar is messed up
                if (doRoch) {
                    mu1 *= mcSF1;
                    mu2 *= mcSF2;
                }
    ...
    if (normToData)
        plotZmumu.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumu2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotZmumu2.SetLogy();
    ...
    if (normToData)
        plotZmumuNPV.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuNPV2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuZPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuZPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuPhiStar.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuPhiStar2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuZRap.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuZRap2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep1Pt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep1Pt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep2Pt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep2Pt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLepNegPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLepNegPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLepPosPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLepPosPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep1Eta.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep1Eta2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep2Eta.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZmumuLep2Eta2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
