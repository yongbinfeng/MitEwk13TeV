    ...
    )
{
    ...
    fnamev.push_back(inputDir + TString("/") + TString("data_select.root"));
    typev.push_back(eData);
    fnamev.push_back(inputDir + TString("/") + TString("zee_select.root"));
    typev.push_back(eZee);
    ...
    if (sqrts == "5TeV") {
        fnamev.push_back(inputDir + TString("/") + TString("wx_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("zxx_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("wz_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("ww_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("zz_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("top_select.root"));
        typev.push_back(eTop);
    } else {
        fnamev.push_back(inputDir + TString("/") + TString("wx0_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("wx1_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("wx2_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("zxx_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("ww_select.root"));
        ...
        fnamev.push_back(inputDir + TString("/") + TString("zz_select.root"));
        typev.push_back(eEWK);
        fnamev.push_back(inputDir + TString("/") + TString("top1_select.root"));
        typev.push_back(eTop);
        fnamev.push_back(inputDir + TString("/") + TString("top2_select.root"));
        typev.push_back(eTop);
        fnamev.push_back(inputDir + TString("/") + TString("top3_select.root"));
        typev.push_back(eTop);
    }
    ...
    for (int i = 0; i < 1000; i++) {
        if (i % 100000 == 0)
            cout << "Processing event " << i << ". " << (double)i / (double)treeData->GetEntries() * 100 << " percent done with this file." << endl;
        ...
        if (runNumber != 307017)
            continue; // || lumiBlock != 81) continue;
        // if(fabs(etaEle[0])>ETA_CUT||fabs(etaEle[1])>ETA_CUT) continue;
        if (fabs(etaEle[0]) > ETA_CUT || fabs(etaEle[1]) > ETA_CUT)
            continue;
        if (fabs(etaEle[0]) >= ECAL_GAP_LOW && fabs(etaEle[0]) <= ECAL_GAP_HIGH)
            continue;
        if (fabs(etaEle[1]) >= ECAL_GAP_LOW && fabs(etaEle[1]) <= ECAL_GAP_HIGH)
            continue;
        ...
        if (energy_ECAL_ele[0] / cosh(fabs(etaEle[0])) < PT_CUT || energy_ECAL_ele[1] / cosh(fabs(etaEle[1])) < PT_CUT)
            continue;
        ...
        if (clep1.Pt() < PT_CUT || clep2.Pt() < PT_CUT)
            continue;
        dl = clep1 + clep2;
    ...
    for (int i = 0; i < 1000; i++) {
        if (i % 100000 == 0)
            cout << "Processing event " << i << ". " << (double)i / (double)treeMC->GetEntries() * 100 << " percent done with this file." << endl;
    ...
    TH1D* hData = new TH1D("hData", "", NBINS, MASS_LOW, MASS_HIGH);
    hData->Sumw2();
    TH1D* hZee = new TH1D("hZee", "", NBINS, MASS_LOW, MASS_HIGH);
    hZee->Sumw2();
    TH1D* hEWK = new TH1D("hEWK", "", NBINS, MASS_LOW, MASS_HIGH);
    hEWK->Sumw2();
    TH1D* hTop = new TH1D("hTop", "", NBINS, MASS_LOW, MASS_HIGH);
    hTop->Sumw2();
    TH1D* hMC = new TH1D("hMC", "", NBINS, MASS_LOW, MASS_HIGH);
    hMC->Sumw2();

    TH1D* hDataNPV = new TH1D("hDataNPV", "", 50, 0, 50);
    hDataNPV->Sumw2();
    TH1D* hZeeNPV = new TH1D("hZeeNPV", "", 50, 0, 50);
    hZeeNPV->Sumw2();
    TH1D* hEWKNPV = new TH1D("hEWKNPV", "", 50, 0, 50);
    hEWKNPV->Sumw2();
    TH1D* hTopNPV = new TH1D("hTopNPV", "", 50, 0, 50);
    hTopNPV->Sumw2();
    TH1D* hMCNPV = new TH1D("hMCNPV", "", 50, 0, 50);
    hMCNPV->Sumw2();

    const int nBinsZPt = sizeof(ZPtBins) / sizeof(double) - 1;
    TH1D* hDataZPt = new TH1D("hDataZPt", "", nBinsZPt, ZPtBins);
    hDataZPt->Sumw2();
    TH1D* hZeeZPt = new TH1D("hZeeZPt", "", nBinsZPt, ZPtBins);
    hZeeZPt->Sumw2();
    TH1D* hEWKZPt = new TH1D("hEWKZPt", "", nBinsZPt, ZPtBins);
    hEWKZPt->Sumw2();
    TH1D* hTopZPt = new TH1D("hTopZPt", "", nBinsZPt, ZPtBins);
    hTopZPt->Sumw2();
    TH1D* hMCZPt = new TH1D("hMCZPt", "", nBinsZPt, ZPtBins);
    hMCZPt->Sumw2();

    TH1D* hEWKZPt_EffBin = new TH1D("hEWKZPt_EffBin", "", nBinsZPt, ZPtBins);
    hEWKZPt_EffBin->Sumw2();
    TH1D* hTopZPt_EffBin = new TH1D("hTopZPt_EffBin", "", nBinsZPt, ZPtBins);
    hTopZPt_EffBin->Sumw2();
    TH1D* hEWKZPt_EffStatUp = new TH1D("hEWKZPt_EffStatUp", "", nBinsZPt, ZPtBins);
    hEWKZPt_EffStatUp->Sumw2();
    TH1D* hTopZPt_EffStatUp = new TH1D("hTopZPt_EffStatUp", "", nBinsZPt, ZPtBins);
    hTopZPt_EffStatUp->Sumw2();
    TH1D* hEWKZPt_EffStatDown = new TH1D("hEWKZPt_EffStatDown", "", nBinsZPt, ZPtBins);
    hEWKZPt_EffStatDown->Sumw2();
    TH1D* hTopZPt_EffStatDown = new TH1D("hTopZPt_EffStatDown", "", nBinsZPt, ZPtBins);
    hTopZPt_EffStatDown->Sumw2();
    TH1D* hEWKZPt_EffSigShape = new TH1D("hEWKZPt_EffSigShape", "", nBinsZPt, ZPtBins);
    hEWKZPt_EffSigShape->Sumw2();
    TH1D* hTopZPt_EffSigShape = new TH1D("hTopZPt_EffSigShape", "", nBinsZPt, ZPtBins);
    hTopZPt_EffSigShape->Sumw2();
    TH1D* hEWKZPt_EffBkgShape = new TH1D("hEWKZPt_EffBkgShape", "", nBinsZPt, ZPtBins);
    hEWKZPt_EffBkgShape->Sumw2();
    TH1D* hTopZPt_EffBkgShape = new TH1D("hTopZPt_EffBkgShape", "", nBinsZPt, ZPtBins);
    hTopZPt_EffBkgShape->Sumw2();

    const int nBinsPhiStar = sizeof(PhiStarBins) / sizeof(double) - 1;
    TH1D* hDataPhiStar = new TH1D("hDataPhiStar", "", nBinsPhiStar, PhiStarBins);
    hDataPhiStar->Sumw2();
    TH1D* hZeePhiStar = new TH1D("hZeePhiStar", "", nBinsPhiStar, PhiStarBins);
    hZeePhiStar->Sumw2();
    TH1D* hEWKPhiStar = new TH1D("hEWKPhiStar", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar->Sumw2();
    TH1D* hTopPhiStar = new TH1D("hTopPhiStar", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar->Sumw2();
    TH1D* hMCPhiStar = new TH1D("hMCPhiStar", "", nBinsPhiStar, PhiStarBins);
    hMCPhiStar->Sumw2();
    TH1D* hEWKPhiStar_EffBin = new TH1D("hEWKPhiStar_EffBin", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar_EffBin->Sumw2();
    TH1D* hTopPhiStar_EffBin = new TH1D("hTopPhiStar_EffBin", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar_EffBin->Sumw2();
    TH1D* hEWKPhiStar_EffStatUp = new TH1D("hEWKPhiStar_EffStatUp", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar_EffStatUp->Sumw2();
    TH1D* hTopPhiStar_EffStatUp = new TH1D("hTopPhiStar_EffStatUp", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar_EffStatUp->Sumw2();
    TH1D* hEWKPhiStar_EffStatDown = new TH1D("hEWKPhiStar_EffStatDown", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar_EffStatDown->Sumw2();
    TH1D* hTopPhiStar_EffStatDown = new TH1D("hTopPhiStar_EffStatDown", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar_EffStatDown->Sumw2();
    TH1D* hEWKPhiStar_EffSigShape = new TH1D("hEWKPhiStar_EffSigShape", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar_EffSigShape->Sumw2();
    TH1D* hTopPhiStar_EffSigShape = new TH1D("hTopPhiStar_EffSigShape", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar_EffSigShape->Sumw2();
    TH1D* hEWKPhiStar_EffBkgShape = new TH1D("hEWKPhiStar_EffBkgShape", "", nBinsPhiStar, PhiStarBins);
    hEWKPhiStar_EffBkgShape->Sumw2();
    TH1D* hTopPhiStar_EffBkgShape = new TH1D("hTopPhiStar_EffBkgShape", "", nBinsPhiStar, PhiStarBins);
    hTopPhiStar_EffBkgShape->Sumw2();

    TH1D* hDataZRap = new TH1D("hDataZRap", "", 24, 0, 2.4);
    hDataZRap->Sumw2();
    TH1D* hZeeZRap = new TH1D("hZeeZRap", "", 24, 0, 2.4);
    hZeeZRap->Sumw2();
    TH1D* hEWKZRap = new TH1D("hEWKZRap", "", 24, 0, 2.4);
    hEWKZRap->Sumw2();
    TH1D* hTopZRap = new TH1D("hTopZRap", "", 24, 0, 2.4);
    hTopZRap->Sumw2();
    TH1D* hMCZRap = new TH1D("hMCZRap", "", 24, 0, 2.4);
    hMCZRap->Sumw2();

    TH1D* hZeeZRapUp = new TH1D("hZeeZRapUp", "", 24, 0, 2.4);
    hZeeZRapUp->Sumw2();
    TH1D* hZeeZRapDown = new TH1D("hZeeZRapDown", "", 24, 0, 2.4);
    hZeeZRapDown->Sumw2();

    TH1D* hEWKZRap_EffBin = new TH1D("hEWKZRap_EffBin", "", 24, 0, 2.4);
    hEWKZRap_EffBin->Sumw2();
    TH1D* hTopZRap_EffBin = new TH1D("hTopZRap_EffBin", "", 24, 0, 2.4);
    hTopZRap_EffBin->Sumw2();
    TH1D* hEWKZRap_EffStatUp = new TH1D("hEWKZRap_EffStatUp", "", 24, 0, 2.4);
    hEWKZRap_EffStatUp->Sumw2();
    TH1D* hTopZRap_EffStatUp = new TH1D("hTopZRap_EffStatUp", "", 24, 0, 2.4);
    hTopZRap_EffStatUp->Sumw2();
    TH1D* hEWKZRap_EffStatDown = new TH1D("hEWKZRap_EffStatDown", "", 24, 0, 2.4);
    hEWKZRap_EffStatDown->Sumw2();
    TH1D* hTopZRap_EffStatDown = new TH1D("hTopZRap_EffStatDown", "", 24, 0, 2.4);
    hTopZRap_EffStatDown->Sumw2();
    TH1D* hEWKZRap_EffSigShape = new TH1D("hEWKZRap_EffSigShape", "", 24, 0, 2.4);
    hEWKZRap_EffSigShape->Sumw2();
    TH1D* hTopZRap_EffSigShape = new TH1D("hTopZRap_EffSigShape", "", 24, 0, 2.4);
    hTopZRap_EffSigShape->Sumw2();
    TH1D* hEWKZRap_EffBkgShape = new TH1D("hEWKZRap_EffBkgShape", "", 24, 0, 2.4);
    hEWKZRap_EffBkgShape->Sumw2();
    TH1D* hTopZRap_EffBkgShape = new TH1D("hTopZRap_EffBkgShape", "", 24, 0, 2.4);
    hTopZRap_EffBkgShape->Sumw2();

    const int nBinsLep1Pt = sizeof(Lep1PtBins) / sizeof(double) - 1;
    TH1D* hDataLep1Pt = new TH1D("hDataLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hDataLep1Pt->Sumw2();
    TH1D* hZeeLep1Pt = new TH1D("hZeeLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hZeeLep1Pt->Sumw2();
    TH1D* hEWKLep1Pt = new TH1D("hEWKLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt->Sumw2();
    TH1D* hTopLep1Pt = new TH1D("hTopLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt->Sumw2();
    TH1D* hMCLep1Pt = new TH1D("hMCLep1Pt", "", nBinsLep1Pt, Lep1PtBins);
    hMCLep1Pt->Sumw2();

    TH1D* hEWKLep1Pt_EffBin = new TH1D("hEWKLep1Pt_EffBin", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt_EffBin->Sumw2();
    TH1D* hTopLep1Pt_EffBin = new TH1D("hTopLep1Pt_EffBin", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt_EffBin->Sumw2();
    TH1D* hEWKLep1Pt_EffStatUp = new TH1D("hEWKLep1Pt_EffStatUp", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt_EffStatUp->Sumw2();
    TH1D* hTopLep1Pt_EffStatUp = new TH1D("hTopLep1Pt_EffStatUp", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt_EffStatUp->Sumw2();
    TH1D* hEWKLep1Pt_EffStatDown = new TH1D("hEWKLep1Pt_EffStatDown", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt_EffStatDown->Sumw2();
    TH1D* hTopLep1Pt_EffStatDown = new TH1D("hTopLep1Pt_EffStatDown", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt_EffStatDown->Sumw2();
    TH1D* hEWKLep1Pt_EffSigShape = new TH1D("hEWKLep1Pt_EffSigShape", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt_EffSigShape->Sumw2();
    TH1D* hTopLep1Pt_EffSigShape = new TH1D("hTopLep1Pt_EffSigShape", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt_EffSigShape->Sumw2();
    TH1D* hEWKLep1Pt_EffBkgShape = new TH1D("hEWKLep1Pt_EffBkgShape", "", nBinsLep1Pt, Lep1PtBins);
    hEWKLep1Pt_EffBkgShape->Sumw2();
    TH1D* hTopLep1Pt_EffBkgShape = new TH1D("hTopLep1Pt_EffBkgShape", "", nBinsLep1Pt, Lep1PtBins);
    hTopLep1Pt_EffBkgShape->Sumw2();

    const int nBinsLep2Pt = sizeof(Lep2PtBins) / sizeof(double) - 1;
    TH1D* hDataLep2Pt = new TH1D("hDataLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hDataLep2Pt->Sumw2();
    TH1D* hZeeLep2Pt = new TH1D("hZeeLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hZeeLep2Pt->Sumw2();
    TH1D* hEWKLep2Pt = new TH1D("hEWKLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt->Sumw2();
    TH1D* hTopLep2Pt = new TH1D("hTopLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt->Sumw2();
    TH1D* hMCLep2Pt = new TH1D("hMCLep2Pt", "", nBinsLep2Pt, Lep2PtBins);
    hMCLep2Pt->Sumw2();

    TH1D* hEWKLep2Pt_EffBin = new TH1D("hEWKLep2Pt_EffBin", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt_EffBin->Sumw2();
    TH1D* hTopLep2Pt_EffBin = new TH1D("hTopLep2Pt_EffBin", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt_EffBin->Sumw2();
    TH1D* hEWKLep2Pt_EffStatUp = new TH1D("hEWKLep2Pt_EffStatUp", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt_EffStatUp->Sumw2();
    TH1D* hTopLep2Pt_EffStatUp = new TH1D("hTopLep2Pt_EffStatUp", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt_EffStatUp->Sumw2();
    TH1D* hEWKLep2Pt_EffStatDown = new TH1D("hEWKLep2Pt_EffStatDown", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt_EffStatDown->Sumw2();
    TH1D* hTopLep2Pt_EffStatDown = new TH1D("hTopLep2Pt_EffStatDown", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt_EffStatDown->Sumw2();
    TH1D* hEWKLep2Pt_EffSigShape = new TH1D("hEWKLep2Pt_EffSigShape", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt_EffSigShape->Sumw2();
    TH1D* hTopLep2Pt_EffSigShape = new TH1D("hTopLep2Pt_EffSigShape", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt_EffSigShape->Sumw2();
    TH1D* hEWKLep2Pt_EffBkgShape = new TH1D("hEWKLep2Pt_EffBkgShape", "", nBinsLep2Pt, Lep2PtBins);
    hEWKLep2Pt_EffBkgShape->Sumw2();
    TH1D* hTopLep2Pt_EffBkgShape = new TH1D("hTopLep2Pt_EffBkgShape", "", nBinsLep2Pt, Lep2PtBins);
    hTopLep2Pt_EffBkgShape->Sumw2();

    const int nBinsLepNegPt = sizeof(LepNegPtBins) / sizeof(double) - 1;
    TH1D* hDataLepNegPt = new TH1D("hDataLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hDataLepNegPt->Sumw2();
    TH1D* hZeeLepNegPt = new TH1D("hZeeLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hZeeLepNegPt->Sumw2();
    TH1D* hEWKLepNegPt = new TH1D("hEWKLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt->Sumw2();
    TH1D* hTopLepNegPt = new TH1D("hTopLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt->Sumw2();
    TH1D* hMCLepNegPt = new TH1D("hMCLepNegPt", "", nBinsLepNegPt, LepNegPtBins);
    hMCLepNegPt->Sumw2();

    TH1D* hEWKLepNegPt_EffBin = new TH1D("hEWKLepNegPt_EffBin", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt_EffBin->Sumw2();
    TH1D* hTopLepNegPt_EffBin = new TH1D("hTopLepNegPt_EffBin", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt_EffBin->Sumw2();
    TH1D* hEWKLepNegPt_EffStatUp = new TH1D("hEWKLepNegPt_EffStatUp", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt_EffStatUp->Sumw2();
    TH1D* hTopLepNegPt_EffStatUp = new TH1D("hTopLepNegPt_EffStatUp", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt_EffStatUp->Sumw2();
    TH1D* hEWKLepNegPt_EffStatDown = new TH1D("hEWKLepNegPt_EffStatDown", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt_EffStatDown->Sumw2();
    TH1D* hTopLepNegPt_EffStatDown = new TH1D("hTopLepNegPt_EffStatDown", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt_EffStatDown->Sumw2();
    TH1D* hEWKLepNegPt_EffSigShape = new TH1D("hEWKLepNegPt_EffSigShape", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt_EffSigShape->Sumw2();
    TH1D* hTopLepNegPt_EffSigShape = new TH1D("hTopLepNegPt_EffSigShape", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt_EffSigShape->Sumw2();
    TH1D* hEWKLepNegPt_EffBkgShape = new TH1D("hEWKLepNegPt_EffBkgShape", "", nBinsLepNegPt, LepNegPtBins);
    hEWKLepNegPt_EffBkgShape->Sumw2();
    TH1D* hTopLepNegPt_EffBkgShape = new TH1D("hTopLepNegPt_EffBkgShape", "", nBinsLepNegPt, LepNegPtBins);
    hTopLepNegPt_EffBkgShape->Sumw2();

    const int nBinsLepPosPt = sizeof(LepPosPtBins) / sizeof(double) - 1;
    TH1D* hDataLepPosPt = new TH1D("hDataLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hDataLepPosPt->Sumw2();
    TH1D* hZeeLepPosPt = new TH1D("hZeeLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hZeeLepPosPt->Sumw2();
    TH1D* hEWKLepPosPt = new TH1D("hEWKLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt->Sumw2();
    TH1D* hTopLepPosPt = new TH1D("hTopLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt->Sumw2();
    TH1D* hMCLepPosPt = new TH1D("hMCLepPosPt", "", nBinsLepPosPt, LepPosPtBins);
    hMCLepPosPt->Sumw2();

    TH1D* hEWKLepPosPt_EffBin = new TH1D("hEWKLepPosPt_EffBin", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt_EffBin->Sumw2();
    TH1D* hTopLepPosPt_EffBin = new TH1D("hTopLepPosPt_EffBin", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt_EffBin->Sumw2();
    TH1D* hEWKLepPosPt_EffStatUp = new TH1D("hEWKLepPosPt_EffStatUp", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt_EffStatUp->Sumw2();
    TH1D* hTopLepPosPt_EffStatUp = new TH1D("hTopLepPosPt_EffStatUp", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt_EffStatUp->Sumw2();
    TH1D* hEWKLepPosPt_EffStatDown = new TH1D("hEWKLepPosPt_EffStatDown", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt_EffStatDown->Sumw2();
    TH1D* hTopLepPosPt_EffStatDown = new TH1D("hTopLepPosPt_EffStatDown", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt_EffStatDown->Sumw2();
    TH1D* hEWKLepPosPt_EffSigShape = new TH1D("hEWKLepPosPt_EffSigShape", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt_EffSigShape->Sumw2();
    TH1D* hTopLepPosPt_EffSigShape = new TH1D("hTopLepPosPt_EffSigShape", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt_EffSigShape->Sumw2();
    TH1D* hEWKLepPosPt_EffBkgShape = new TH1D("hEWKLepPosPt_EffBkgShape", "", nBinsLepPosPt, LepPosPtBins);
    hEWKLepPosPt_EffBkgShape->Sumw2();
    TH1D* hTopLepPosPt_EffBkgShape = new TH1D("hTopLepPosPt_EffBkgShape", "", nBinsLepPosPt, LepPosPtBins);
    hTopLepPosPt_EffBkgShape->Sumw2();

    TH1D* hDataLep1Eta = new TH1D("hDataLep1Eta", "", 24, 0, 2.4);
    hDataLep1Eta->Sumw2();
    TH1D* hZeeLep1Eta = new TH1D("hZeeLep1Eta", "", 24, 0, 2.4);
    hZeeLep1Eta->Sumw2();
    TH1D* hEWKLep1Eta = new TH1D("hEWKLep1Eta", "", 24, 0, 2.4);
    hEWKLep1Eta->Sumw2();
    TH1D* hTopLep1Eta = new TH1D("hTopLep1Eta", "", 24, 0, 2.4);
    hTopLep1Eta->Sumw2();
    TH1D* hMCLep1Eta = new TH1D("hMCLep1Eta", "", 24, 0, 2.4);
    hMCLep1Eta->Sumw2();

    TH1D* hEWKLep1Eta_EffBin = new TH1D("hEWKLep1Eta_EffBin", "", 24, 0, 2.4);
    hEWKLep1Eta_EffBin->Sumw2();
    TH1D* hTopLep1Eta_EffBin = new TH1D("hTopLep1Eta_EffBin", "", 24, 0, 2.4);
    hTopLep1Eta_EffBin->Sumw2();
    TH1D* hEWKLep1Eta_EffStatUp = new TH1D("hEWKLep1Eta_EffStatUp", "", 24, 0, 2.4);
    hEWKLep1Eta_EffStatUp->Sumw2();
    TH1D* hTopLep1Eta_EffStatUp = new TH1D("hTopLep1Eta_EffStatUp", "", 24, 0, 2.4);
    hTopLep1Eta_EffStatUp->Sumw2();
    TH1D* hEWKLep1Eta_EffStatDown = new TH1D("hEWKLep1Eta_EffStatDown", "", 24, 0, 2.4);
    hEWKLep1Eta_EffStatDown->Sumw2();
    TH1D* hTopLep1Eta_EffStatDown = new TH1D("hTopLep1Eta_EffStatDown", "", 24, 0, 2.4);
    hTopLep1Eta_EffStatDown->Sumw2();
    TH1D* hEWKLep1Eta_EffSigShape = new TH1D("hEWKLep1Eta_EffSigShape", "", 24, 0, 2.4);
    hEWKLep1Eta_EffSigShape->Sumw2();
    TH1D* hTopLep1Eta_EffSigShape = new TH1D("hTopLep1Eta_EffSigShape", "", 24, 0, 2.4);
    hTopLep1Eta_EffSigShape->Sumw2();
    TH1D* hEWKLep1Eta_EffBkgShape = new TH1D("hEWKLep1Eta_EffBkgShape", "", 24, 0, 2.4);
    hEWKLep1Eta_EffBkgShape->Sumw2();
    TH1D* hTopLep1Eta_EffBkgShape = new TH1D("hTopLep1Eta_EffBkgShape", "", 24, 0, 2.4);
    hTopLep1Eta_EffBkgShape->Sumw2();

    TH1D* hDataLep2Eta = new TH1D("hDataLep2Eta", "", 24, 0, 2.4);
    hDataLep2Eta->Sumw2();
    TH1D* hZeeLep2Eta = new TH1D("hZeeLep2Eta", "", 24, 0, 2.4);
    hZeeLep2Eta->Sumw2();
    TH1D* hEWKLep2Eta = new TH1D("hEWKLep2Eta", "", 24, 0, 2.4);
    hEWKLep2Eta->Sumw2();
    TH1D* hTopLep2Eta = new TH1D("hTopLep2Eta", "", 24, 0, 2.4);
    hTopLep2Eta->Sumw2();
    TH1D* hMCLep2Eta = new TH1D("hMCLep2Eta", "", 24, 0, 2.4);
    hMCLep2Eta->Sumw2();

    TH1D* hEWKLep2Eta_EffBin = new TH1D("hEWKLep2Eta_EffBin", "", 24, 0, 2.4);
    hEWKLep2Eta_EffBin->Sumw2();
    TH1D* hTopLep2Eta_EffBin = new TH1D("hTopLep2Eta_EffBin", "", 24, 0, 2.4);
    hTopLep2Eta_EffBin->Sumw2();
    TH1D* hEWKLep2Eta_EffStatUp = new TH1D("hEWKLep2Eta_EffStatUp", "", 24, 0, 2.4);
    hEWKLep2Eta_EffStatUp->Sumw2();
    TH1D* hTopLep2Eta_EffStatUp = new TH1D("hTopLep2Eta_EffStatUp", "", 24, 0, 2.4);
    hTopLep2Eta_EffStatUp->Sumw2();
    TH1D* hEWKLep2Eta_EffStatDown = new TH1D("hEWKLep2Eta_EffStatDown", "", 24, 0, 2.4);
    hEWKLep2Eta_EffStatDown->Sumw2();
    TH1D* hTopLep2Eta_EffStatDown = new TH1D("hTopLep2Eta_EffStatDown", "", 24, 0, 2.4);
    hTopLep2Eta_EffStatDown->Sumw2();
    TH1D* hEWKLep2Eta_EffSigShape = new TH1D("hEWKLep2Eta_EffSigShape", "", 24, 0, 2.4);
    hEWKLep2Eta_EffSigShape->Sumw2();
    TH1D* hTopLep2Eta_EffSigShape = new TH1D("hTopLep2Eta_EffSigShape", "", 24, 0, 2.4);
    hTopLep2Eta_EffSigShape->Sumw2();
    TH1D* hEWKLep2Eta_EffBkgShape = new TH1D("hEWKLep2Eta_EffBkgShape", "", 24, 0, 2.4);
    hEWKLep2Eta_EffBkgShape->Sumw2();
    TH1D* hTopLep2Eta_EffBkgShape = new TH1D("hTopLep2Eta_EffBkgShape", "", 24, 0, 2.4);
    hTopLep2Eta_EffBkgShape->Sumw2();

    TH1D* hGausRandNtuple = new TH1D("hGausRandNtuple", "", 100, -3, 3);
    hGausRandNtuple->Sumw2();
    TH1D* hGausRandHere = new TH1D("hGausRandHere", "", 100, -3, 3);
    hGausRandHere->Sumw2();
    //
    ...
    for (UInt_t ifile = 0; ifile < fnamev.size(); ifile++) {
        ...
        for (UInt_t ientry = 0; ientry < intree->GetEntries(); ientry++) {
            ...
            if (typev[ifile] == eData) {
                ...
                if (lq1 < 0)
                    costhetastar = tanh(float((l1.Rapidity() - l2.Rapidity()) / 2));
                else
                    costhetastar = tanh(float((l2.Rapidity() - l1.Rapidity()) / 2));
    ...
    if (normToData)
        plotGaus.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotGaus2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotGaus2.SetLogy();
    ...
    if (normToData)
        plotZeea.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZee2a.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotZee2a.SetLogy();
    ...
    if (normToData)
        plotZeeb.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZee2b.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotZee2b.SetLogy();
    ...
    if (normToData)
        plotZee_EGcomp.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZee2_EGcomp.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZee.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZee2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotZee2.SetLogy();
    ...
    if (normToData)
        plotZeeNPV.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeNPV2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    plotZeeNPV2.SetLogy();
    ...
    if (normToData)
        plotZeeZPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    // plotZeeZPt.SetLogx();
    ...
    if (normToData)
        plotZeeZPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    // plotZeeZPt2.SetLogx();
    plotZeeZPt2.SetLogy();
    ...
    if (normToData)
        plotZeePhiStar.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeePhiStar2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeZRap.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeZRap2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep1Pt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep1Pt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep2Pt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep2Pt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLepNegPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLepNegPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLepPosPt.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLepPosPt2.AddTextBox(normtext, 0.6, 0.55, 0.95, 0.60, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep1Eta.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep1Eta2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep2Eta.AddTextBox(normtext, 0.6, 0.65, 0.95, 0.70, 0, 13, 0.03, -1);
    ...
    if (normToData)
        plotZeeLep2Eta2.AddTextBox(normtext, 0.21, 0.75, 0.45, 0.80, 0, 13, 0.03, -1);
