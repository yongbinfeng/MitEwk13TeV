...
# 5 TeV Z Data
root -l -b -q fitRecoilZll.C+\(\"${In5_Zmm}\",\"data.root\",2,2,0,\"met\",\"metPhi\",\"met\",\"${OUT}/ZmmData_PF_5TeV_2G_bkg_fixRoch\",${LUMI5},0,0,1,0\)
...
# 5 TeV Z Data
root -l -b -q fitRecoilZll.C+\(\"${In5_Zee}\",\"data.root\",2,2,0,\"met\",\"metPhi\",\"met\",\"${OUT}/ZeeData_PF_5TeV_2G_bkg_fixRoch\",${LUMI5},0,0,1,1\)
...
# -------------------------------------------------------------------------------------------------
# central region
root -l -b -q fitRecoilWl.C+\(\"${In5_Wm}\",2,2,1,1,0,\"met\",\"metPhi\",\"met\",\"${OUT}/WmpMC_PF_5TeV_Eta$1\",${LUMI5},1,0,1,0\)
root -l -b -q fitRecoilWl.C+\(\"${In5_Wm}\",2,2,1,-1,0,\"met\",\"metPhi\",\"met\",\"${OUT}/WmmMC_PF_5TeV_Eta1\",${LUMI5},1,0,1,0\)
root -l -b -q fitRecoilZll.C+\(\"${In5_Zmm}\",\"zmm.root\",2,2,1,\"met\",\"metPhi\",\"met\",\"${OUT}/ZmmMC_PF_5TeV_Eta$1\",${LUMI5},1,0,1,0\)
...
root -l -b -q fitRecoilZll.C+\(\"${In5_Zmm}\",\"zmm.root\",2,2,1,\"met\",\"metPhi\",\"met\",\"${OUT}/ZmmMC_PF_5TeV_Eta$3\",${LUMI5},3,0,1,0\)
