...
# -------------------------------------------------------------------------------------------------
# central region
root -l -b -q fitRecoilWl.C+\(\"${In13_Wm}\",2,2,1,1,0,\"met\",\"metPhi\",\"met\",\"${OUT}/WmpMC_PF_13TeV_Eta$1\",${LUMI13},1,0\)
root -l -b -q fitRecoilWl.C+\(\"${In13_Wm}\",2,2,1,-1,0,\"met\",\"metPhi\",\"met\",\"${OUT}/WmmMC_PF_13TeV_Eta1\",${LUMI13},1,0\)
root -l -b -q fitRecoilZll.C+\(\"${In13_Zmm}\",\"zmm.root\",2,2,1,\"met\",\"metPhi\",\"met\",\"${OUT}/ZmmMC_PF_13TeV_Eta$1\",${LUMI13},1,0\)
...
root -l -b -q fitRecoilZll.C+\(\"${In13_Zmm}\",\"zmm.root\",2,2,1,\"met\",\"metPhi\",\"met\",\"${OUT}/ZmmMC_PF_13TeV_Eta$3\",${LUMI13},3,0\)
