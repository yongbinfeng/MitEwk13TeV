...
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wmp_5TeV_amcPythia_dressed\",\"ACC_wmp_5_amcPythia_dressed\",1,1,0,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wmm_5TeV_amcPythia_dressed\",\"ACC_wmm_5_amcPythia_dressed\",1,-1,0,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wm_5TeV_amcPythia_dressed\",\"ACC_wm_5_amcPythia_dressed\",1,0,0,1,${FRAC}\)

# born level
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wmp_5TeV_amcPythia_born\",\"ACC_wmp_5_amcPythia_born\",1,1,1,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wmm_5TeV_amcPythia_born\",\"ACC_wmm_5_amcPythia_born\",1,-1,1,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wm_5TeV_amcPythia_born\",\"ACC_wm_5_amcPythia_born\",1,0,1,1,${FRAC}\)
...
#root -l -b -q computeAccGenWl.C+\(\"wm5_powheg.conf\",\"${OUTDIR}/GEN_wmp_5TeV_powPythia_dressed\",\"ACC_wmp_5_powPythia_dressed\",1,1\)
#root -l -b -q computeAccGenWl.C+\(\"wm5_powheg.conf\",\"${OUTDIR}/GEN_wmm_5TeV_powPythia_dressed\",\"ACC_wmm_5_powPythia_dressed\",1,-1\)
#root -l -b -q computeAccGenWl.C+\(\"wm5_powheg.conf\",\"${OUTDIR}/GEN_wm_5TeV_powPythia_dressed\",\"ACC_wm_5_powPythia_dressed\",1,0\)
...
# ################################################################################
##########     aMCnlo+Pythia for RESUMMATION, QCD, and PDF
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wep_5TeV_amcPythia_dressed\",\"ACC_wep_5_amcPythia_dressed\",1,1,0,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wem_5TeV_amcPythia_dressed\",\"ACC_wem_5_amcPythia_dressed\",1,-1,0,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_we_5TeV_amcPythia_dressed\",\"ACC_we_5_amcPythia_dressed\",1,0,0,0,${FRAC}\)

# born l-b evel
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wep_5TeV_amcPythia_born\",\"ACC_wep_5_amcPythia_born\",1,1,1,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_wem_5TeV_amcPythia_born\",\"ACC_wem_5_amcPythia_born\",1,-1,1,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w5.conf\",\"${OUTDIR}/GEN_we_5TeV_amcPythia_born\",\"ACC_we_5_amcPythia_born\",1,0,1,0,${FRAC}\)
...
# ################################################################################
# #########             aMCnlo+Pythia for RESUMMATION, QCD, and PDF
root -l -b -q computeAccGenZll.C+\(\"z5.conf\",\"${OUTDIR}/GEN_zmm_5TeV_amcPythia_dressed\",\"ACC_zmm_5_amcPythia_dressed\",1,0,1,${FRAC}\)
root -l -b -q computeAccGenZll.C+\(\"z5.conf\",\"${OUTDIR}/GEN_zmm_5TeV_amcPythia_born\",\"ACC_zmm_5_amcPythia_born\",1,1,1,${FRAC}\)
# ################################################################################
# #########             aMCnlo+Pythia for RESUMMATION, QCD, and PDF
...
root -l -q -b computeAccGenZll.C+\(\"z5.conf\",\"${OUTDIR}/GEN_zee_5TeV_amcPythia_dressed\",\"ACC_zee_5_amcPythia_dressed\",1,0,0,${FRAC}\)
root -l -q -b computeAccGenZll.C+\(\"z5.conf\",\"${OUTDIR}/GEN_zee_5TeV_amcPythia_born\",\"ACC_zee_5_amcPythia_born\",1,1,0,${FRAC}\)
