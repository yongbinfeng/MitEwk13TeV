...
# born level
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_wmp_13TeV_amcPythia_born\",\"ACC_wmp_13_amcPythia_born\",1,1,1,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_wmm_13TeV_amcPythia_born\",\"ACC_wmm_13_amcPythia_born\",1,-1,1,1,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_wm_13TeV_amcPythia_born\",\"ACC_wm_13_amcPythia_born\",1,0,1,1,${FRAC}\)
...
# born level
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_wep_13TeV_amcPythia_born\",\"ACC_wep_13_amcPythia_born\",1,1,1,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_wem_13TeV_amcPythia_born\",\"ACC_wem_13_amcPythia_born\",1,-1,1,0,${FRAC}\)
root -l -b -q computeAccGenWl.C+\(\"w13.conf\",\"${OUTDIR}/GEN_we_13TeV_amcPythia_born\",\"ACC_we_13_amcPythia_born\",1,0,1,0,${FRAC}\)
...
root -l -b -q computeAccGenZll.C+\(\"z13.conf\",\"${OUTDIR}/GEN_zmm_13TeV_amcPythia_born\",\"ACC_zmm_13_amcPythia_born\",1,1,1,${FRAC}\)
# ################################################################################
...
root -l -b -q computeAccGenZll.C+\(\"z13.conf\",\"${OUTDIR}/GEN_zee_13TeV_amcPythia_born\",\"ACC_zee_13_amcPythia_born\",1,1,0,${FRAC}\)
# ################################################################################
# # ##########             aMCnlo+Pythia for RESUMMATION
