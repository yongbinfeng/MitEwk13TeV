...
CMCDatasetConvGaussian::CMCDatasetConvGaussian(const char* name, RooRealVar& m, TTree* tree)
{
    ...
    sprintf(vname, "dataSet_%s", name);
    dataSet = new RooDataSet(vname, vname, inTree, RooArgSet(m));
    sprintf(vname, "keysPdf_%s", name);
