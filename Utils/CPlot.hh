...
public:
    ...
    {
        assert(fLeg);
        fLeg->SetX1(fLeg->GetX1() + dx);
        fLeg->SetY1(fLeg->GetY1() + dy);
        fLeg->SetX2(fLeg->GetX2() + dx);
        fLeg->SetY2(fLeg->GetY2() + dy);
    }

    // Set stats box position
    void SetStats(double x, double y)
    {
        fStatsX = x;
        fStatsY = y;
    }
    ...
    // Translate stats box
    void TransStats(double dx, double dy)
    {
        fStatsX += dx;
        fStatsY += dy;
    }
